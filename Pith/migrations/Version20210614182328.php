 ...
 */
final class Version20210614182328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pet (id INT AUTO_INCREMENT NOT NULL, breed_id INT NOT NULL, type_id INT NOT NULL, name VARCHAR(60) NOT NULL, id_card VARCHAR(15) DEFAULT NULL, tatoo VARCHAR(10) DEFAULT NULL, description LONGTEXT NOT NULL, INDEX IDX_E4529B85A8B4A30F (breed_id), INDEX IDX_E4529B85C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
